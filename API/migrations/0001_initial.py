# Generated by Django 4.2.7 on 2023-11-02 15:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Moderation', 'Moderatsiya'), ('New', 'Yangi'), ('Approved', 'Tasdiqlangan'), ('Cancelled', 'Bekor qilingan')], default='New', max_length=50, verbose_name='Homiy holati')),
                ('type', models.CharField(choices=[('legal', 'yuridik'), ('physical', 'jismoniy')], max_length=50, verbose_name='Shaxs turi')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('degree', models.CharField(choices=[('bachelor', 'bakalavr'), ('master', 'magistor')], default='bachelor', max_length=50, verbose_name='Darajasi')),
            ],
        ),
        migrations.CreateModel(
            name='University',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sponsor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='API.sponsor', verbose_name='Sponsor')),
